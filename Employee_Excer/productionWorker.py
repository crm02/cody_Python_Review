...
class ProductionWorker(Employee):
    def __init__(self,employee_name,employee_number,shift_num,hourly_pay):
        Employee.__init__(self,employee_name,employee_number)
        self.__shiftNum = shift_num
        self.__hourlyPay = hourly_pay


    def set_shiftNum(self,one_Or_Two):
        self.__shiftNum =one_Or_Two

    def set_hourlyPay(self,amount):
        self.__hourlyPay =amount
